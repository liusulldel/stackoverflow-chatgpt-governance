...
```mermaid
flowchart LR
    A["Private AI as outside option"] --> B["Residualized public queue"]
    B --> C["Earlier-role reallocation in answer pipeline"]
    C --> D["Weaker downstream certification"]
    E["Durability of public entrant margin"] --> C
    F["Canonical 2025Q4 dump backbone"] --> B
    F --> C
    F --> D
    G["Timing / direct-AI / external layers"] --> D
```
...
![Answer Roles](D:/AI%20alignment/projects/stackoverflow_chatgpt_governance/figures/who_still_answers_answer_role_mechanism.png)
...
![Durability](D:/AI%20alignment/projects/stackoverflow_chatgpt_governance/figures/who_still_answers_durability_mechanism.png)
...
- ![External Timing](D:/AI%20alignment/projects/stackoverflow_chatgpt_governance/figures/who_still_answers_external_ai_timing_layer.png)
- ![Internal Timing](D:/AI%20alignment/projects/stackoverflow_chatgpt_governance/figures/who_still_answers_internal_ai_timing_trace.png)
...
![AIDev](D:/AI%20alignment/projects/stackoverflow_chatgpt_governance/figures/who_still_answers_aidev_review_certification.png)
